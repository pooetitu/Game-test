...
void ClientRun(SDL_Renderer* renderer, SDL_Window* window) {
    int h = WINDOW_HEIGHT;
    int w = WINDOW_WIDTH;
    PlayerData p1 = { w - 15, h - 15, 15, 5.0f, 0, 0, 255, SDL_SCANCODE_UP, SDL_SCANCODE_DOWN, SDL_SCANCODE_LEFT, SDL_SCANCODE_RIGHT };
    PlayerData p2 = { 15, h - 15, 15, 5.0f, 255, 0, 0,SDL_SCANCODE_W,SDL_SCANCODE_S,SDL_SCANCODE_A,SDL_SCANCODE_D };
    Uint8 r = 0, g = 0, b = 0;
    SDL_Event event;
    int quit = 0;
